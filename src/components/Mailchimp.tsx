...
import {Button, Flex, Heading, Input, Text, Background, Spinner} from '@/once-ui/components';
...
export const Mailchimp = (
    ...
    function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        fetch('https://api.apispreadsheets.com/data/uNItMdimMiQocK5a/', {
            method: 'POST',
            headers: {
                    ...
                    <div className="clear">
                        <Flex
                            ...
                            <Button
                                ...
                                {loading ? <Spinner size="m" /> :t("newsletter.button")}
                            </Button>
                        </Flex>
                    </div>
                </Flex>
